...
class MaquinaPersonalizacionRepositoryImplTest {
    ...
    val repositorio = MaquinaPersonalizacionRepositoryImpl(MaquinaPersonalizacionDao)
    val maquinaTest = Maquina.MaquinaPersonalizacion(
        1,
    ...
    companion object {
        ...
        fun setUp(): Unit {
            ...
            val maquina = MaquinaPersonalizacionRepositoryImpl(MaquinaPersonalizacionDao).save(maquinaTest)
        }
    }
}