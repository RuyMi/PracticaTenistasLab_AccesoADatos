...
class MaquinaEncordarRepositoryImplTest {

    val repositorio = MaquinaEncordarRepositoryImpl()
    val maquinaTest = MaquinaEncordadora(
        1,
    ...
    companion object {
        ...
        fun setUp(): Unit {
            ...
            val producto = MaquinaEncordarRepositoryImpl().save(maquinaTest)
        }
    }
