...
class ControladorTest {
    ...
    val controlador =
        ...
        MaquinaPersonalizacionRepositoryImpl(),
    ...
    val maquinaPTest = MaquinaPersonalizacion(
        1,
        UUID.fromString("492a7f86-c34d-43e3-ba77-8083a542f427"),
        "perso",
        "rojo",
    ...
    val maquinaETest = MaquinaEncordadora(
        1,
    ...
    val pedidoTest = UsuarioRepositoryImpl().findById(1)?.let {
        Pedidos(
        1,
    ...
    val tareaTest = ProductosRepositoryImpl().findById(1)?.let {
        Tarea(
        1,
    ...
    companion object{
        ...
        fun setUp(): Unit {
            ...
            TurnosRepositoryImpl().save(turnoTest)
            ...
            val maquinaP = MaquinaPersonalizacionRepositoryImpl().save(maquinaPTest)
            val maquinaETest = MaquinaEncordadora(
                0,
                UUID.fromString("492a7f86-c34d-43e3-ba77-8083a542f434"),
                "nadal",
